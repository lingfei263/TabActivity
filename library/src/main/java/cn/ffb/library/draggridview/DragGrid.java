package cn.ffb.library.draggridview;
...
import cn.ffb.library.Dp2pxUtils;
...
//	private Vibrator mVibrator;
     ...
     * 不可操的条目数
     */
    public static int unMoveCount = 1;
...
//		mVibrator = (Vibrator) context.getSystemService(Context.VIBRATOR_SERVICE);
        //将布局文件中设置的间距dip转为px
        mHorizontalSpacing = Dp2pxUtils.dip2px(context, mHorizontalSpacing);
    }
